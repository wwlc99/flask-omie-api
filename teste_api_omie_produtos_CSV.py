    ...
    "param": [
        {
            ...
            "apenas_importado_api": "N",  # N para listar tudo
            "filtrar_apenas_omiepdv": "N"  # N para listar produtos gerais
        }
    ]
}
...
if response.status_code == 200:
    ...
    if 'produto_servico_cadastro' in dados:
        registros = dados['produto_servico_cadastro']
        ...
        print("Campo 'produto_servico_cadastro' não encontrado na resposta da API.")
else:
